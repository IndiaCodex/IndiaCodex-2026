# IndiaCodex'26 — Submission Process

*This was the submission process used by participants during IndiaCodex'26, preserved for reference. For the event summary and results, see [README.md](README.md).*
