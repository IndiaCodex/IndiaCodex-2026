      ...
      if (detection) {
        ...
        if (ctx) {
          const groups: [number, number, string][] = [
            [0, 16, 'rgba(193,95,60,0.4)'],   // Jaw outline
            [17, 21, '#a855f7'],               // Left eyebrow
            [22, 26, '#a855f7'],               // Right eyebrow
            [27, 35, 'oklch(0.70 0.14 45)'],   // Nose
            [36, 41, '#3b82f6'],               // Left eye
            [42, 47, '#3b82f6'],               // Right eye
            [48, 67, '#10b981'],               // Lips
          ];
