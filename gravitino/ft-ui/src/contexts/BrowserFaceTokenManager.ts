import { FaceTokenAPI, type FaceTokenCircuitKeys, type FaceTokenProviders } from '../../../api/src/index.js';
...
export class BrowserFaceTokenManager {
  ...
  resolve(contractAddress?: ContractAddress): Observable<FaceTokenDeployment> {
    ...
    // Vite may bundle duplicate copies of @midnight-ntwrk/midnight-js-network-id,
    // so we must call setNetworkId from *this* copy every time.
